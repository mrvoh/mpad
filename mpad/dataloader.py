...
def doc2graph(doc, word2idx, window_size, use_directed_edges, normalize_edges, use_master_node):
	...
	# if use_directed_edges:
	#     A = A.transpose()
	if normalize_edges and A.size > 1:
		A = normalize(A)
	...
	def __init__(
		...
		self.graphs = [
			doc2graph(
				...
				use_directed_edges=use_directed_edges,
